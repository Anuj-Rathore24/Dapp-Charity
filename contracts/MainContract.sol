...
contract MyContract {
    ...
    */
    ...
    function generate_address_charity(
        string memory name,
        ...
        string memory length_abc = new string(
            _name.length + _bankacc.length + _bankname.length
        );
    ...
    function generate_address_organisation(
        string memory name,
        string memory bankacc,
        string memory bankname
    ) private returns (bytes32) {
    ...
    */
        ...
        return (cs[index_charity].name_of_charity);
    }
    ...
    */
    ...
    function transact_organisation_to_charity(
        address payable address_of_charity,
        address payable address_of_oranisation
